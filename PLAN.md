...
|---|---|---|---|
| JS transferred, home (≤100KB gzip) | ~15-25KB (Motion One mini ~2.3KB + floor/card interaction scripts ~8-12KB + stage indicator 0KB, no JS + analytics beacon, small) | Lighthouse CI `resource-summary:script:size` assertion (bytes) | Low risk, large headroom |
