/**
 * Lighthouse, mobile, 3 runs, every route, both schemes — run F — `/` and `/sahib/`, the two routes items N1 and N2 touch.
 *
...
const SCRATCH = process.argv[2] ?? '/tmp/lh-runf';
const OUT = join(REPO, 'docs/reviews/runF/engineer/lighthouse');
